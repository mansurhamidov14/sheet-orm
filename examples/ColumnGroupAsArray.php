...
$userSchema->mapKeys(function (ArrayMapping $mapping) {
  ...
  $mapping->field('months')->groupList('monthSchema', 3, 4)->map(function (ArrayMapping $mapping) {
    $mapping->field('days')->groupList('daySchema', 2, 2)->map(function (ArrayMapping $mapping) {
